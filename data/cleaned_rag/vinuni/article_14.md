...
- **MOET**: **University**. Ministry of Education and Training: VinUniversity/VinUni.
- **MOET**: **College**. Ministry of Education and Training: An academic unit that undergraduate students are registered in academic programs.
- **MOET**: **Dean**. Ministry of Education and Training: Refers to the Head of a College or a Faculty.
- **MOET**: **Program Director**. Ministry of Education and Training: A member of the academic staff in a College or a Faculty responsible for administrative matters relating to curriculum development and assurance of learning of majors and minors in an academic program..
- **MOET**: **Course Leader**. Ministry of Education and Training: A member of the academic staff in a College or a Faculty responsible for administrative matters relating to a specific course or a group of courses..
- **MOET**: **Course Instructor**. Ministry of Education and Training: An academic staff who is responsible for delivering a specific course..
- **MOET**: **Degree**. Ministry of Education and Training: The University’s undergraduate curricula are organized into degrees. The bachelor’s degree is normally granted upon completion of a program of study. _For example: Bachelor of Science in Electrical Engineering (BSEE) or Bachelor of Business Administration (BBA) or Bachelor of Nursing (BN)._.
- **MOET**: **Major (Concentration)**. Ministry of Education and Training: A major field of study is the core competence area, comprising a structured group of courses that aims to create a broad and deep intellectual experience in an academic discipline. _For example: Electrical Engineering (as a major) or BBA (Finance) (Finance as a concentration)_.
- **MOET**: **Minor**. Ministry of Education and Training: A minor consists of a structured group of courses that focuses on a particular academic discipline, allowing students to develop some depth of understanding in a subject area or topic of professional interest. _For example: Computer Science/Robotics as a Minor of BSEE; Real Estate as a Minor of BBA._.
- **MOET**: **Double Degree**. Ministry of Education and Training: Students may earn two degrees by fulfilling all the requirements of both degrees. Students who complete the requirements of two major programs, but complete the requirements of only one degree will not be awarded a double degree..
- **MOET**: **Credit Transfer**. Ministry of Education and Training: A process that provides students with agreed and consistent credit outcomes for a component of an academic program based on identified equivalence in content and learning outcomes between matched academic programs..
- **MOET**: **Full-time student**. Ministry of Education and Training: A full-time student is undertaking at least 80% of a full-time load in an academic program. The normal annual full-time load is 30 credits..
- **MOET**: **Conferral**. Ministry of Education and Training: The date on which an academic qualification is granted. This date appears on the student’s official parchment..
- **MOET**: **Academic Standing**. Ministry of Education and Training: Academic standing is an indicator of students’ academic progress..
...
_*Please refer to this document for more details:_ Vietnamese Language Program Guidelines For International Students – VinUni Policy
### Article 3. Academic Program and Syllabi
...
- **Type**: Required Course. **Description**: Contains the main learning outcomes of a section of the curriculum which students are required to pass to be eligible for graduation..
- **Type**: Elective Course. **Description**: Contains the necessary learning outcomes that students are allowed to select themselves (conditionally or freely) according to the guidelines of the Faculty and/or College to diversify their specialization or choose at their volition to accumulate a specified number of courses needed to complete their curriculum..
...
- **Variation**: Normal load. **Academic load per regular Semester**: At least **14 credits** (applicable for first-semester students, and students with good academic standing or higher in the previous semester; not applicable for the final semester). At least 10 credits and no more than 14 credits, applicable to students with poor academic standing in the previous semester.. **Remarks**: This is to complete the degree requirements within a normal specified duration of study..
- **Variation**: Automatic Overload. **Academic load per regular Semester**: 18-22 credits, subject to be reviewed by the Academic Advisor/Program Director.. **Remarks**: This enables students to pursue their studies at a pace commensurate with their needs and/or capabilities.
- **Variation**: Beyond automatic overload. **Academic load per regular Semester**: More than 22 credits, subject to approval by the College Dean or Dean-designee..
...
- **_Class Standing_**: Freshman. **_Number of accumulated credits_**: Below 30.
- **_Class Standing_**: Sophomore. **_Number of accumulated credits_**: 30 – 59.
- **_Class Standing_**: Junior. **_Number of accumulated credits_**: 60 – 89.
- **_Class Standing_**: Senior. **_Number of accumulated credits_**: 90 or more credits.

Class standing applies to Health Sciences:

- **_Class Standing_**: Freshman. **_Number of accumulated credits_**: Below 35.
- **_Class Standing_**: Sophomore. **_Number of accumulated credits_**: 35– 70.
- **_Class Standing_**: Junior. **_Number of accumulated credits_**: 71 – 105.
- **_Class Standing_**: Senior. **_Number of accumulated credits_**: 106 – 140.
- **_Class Standing_**: Fifth-year senior. **_Number of accumulated credits_**: 141 – 175.
- **_Class Standing_**: Sixth-year senior. **_Number of accumulated credits_**: 176 – 255.
...
- **_Academic Standing_**: Excellent. **_Cumulative grade point average GPA_**: 3.60 – 4.00.
- **_Academic Standing_**: Very good. **_Cumulative grade point average GPA_**: 3.20 – 3.59.
- **_Academic Standing_**: Good. **_Cumulative grade point average GPA_**: 2.50 – 3.19.
- **_Academic Standing_**: Marginal. **_Cumulative grade point average GPA_**: 2.00 – 2.49.
- **_Academic Standing_**: Unsatisfactory (At risk). **_Cumulative grade point average GPA_**: Below 2.0.
...
- **Level**: **Academic Warning** _(student’s academic performance has been unsatisfactory, of their overall academic average is below minimum requirements)_. **Criteria**: a) Students get a cumulative GPA under 1.20/4.0 for freshman, under 1.40/4.0 for sophomore, under 1.60/4.0 for third-year or under 1.80/4.0 for seniors and subsequent academic years. Or b) Students earn a semester GPA under 0.80/4.0 in the first semester and under 1.00/4.0 in the following semesters; Or c) Total number of failed credits in the semester exceeds more than half of the number registered for the semester or total number of failed credits from the beginning of the course is more than 24;.
- **Level**: **Academic Probation** _(a student is not making the academic progress the university requires for graduation)_. **Criteria**: A student who is placed on academic warning two consecutive times is subject to academic probation. The student will need to obtain approval from his/her academic advisor to enroll in courses. The student will remain on academic probation until his/her cumulative GPA reaches 1.40/4.0 for sophomore, 1.60/4.0 for juniors, or 1.80/4.0 for seniors and subsequent academic years..
- **Level**: **Academic Dismissal** (_Students who cannot benefit from course registration in the next semester may be suspended for an approved period of not less than one semester)._. **Criteria**: a) Students whose study time exceeds the maximum time allowed to study at the University. Or b) Students who are placed on academic warning three times in total (one academic probation is considered as two times of academic warning), even if those times are not sequential. Recommendations for dismissals are reported to the relevant Dean. Students are entitled to reserve the academic results accumulated when subject to academic dismissal.
...
- **_Grade Letter_**: A. **_4-point scale_**: 4.0.
- **_Grade Letter_**: A-. **_4-point scale_**: 3.7.
- **_Grade Letter_**: B+. **_4-point scale_**: 3.3.
- **_Grade Letter_**: B. **_4-point scale_**: 3.0.
- **_Grade Letter_**: B-. **_4-point scale_**: 2.7.
- **_Grade Letter_**: C+. **_4-point scale_**: 2.3.
- **_Grade Letter_**: C. **_4-point scale_**: 2.0.
- **_Grade Letter_**: C-. **_4-point scale_**: 1.7.
- **_Grade Letter_**: D+. **_4-point scale_**: 1.3.
- **_Grade Letter_**: D. **_4-point scale_**: 1.0.
- **_Grade Letter_**: D-. **_4-point scale_**: 0.7.
- **_Grade Letter_**: F. **_4-point scale_**: 0.0.
...
- **_Grade_**: CR. **_Definitions_**: Completed Requirements (i.e., a Pass grade). The credits and non-credit activities count towards graduation requirements, but they do not contribute to the GPA..
- **_Grade_**: NCR. **_Definitions_**: Not Completed Requirement (i.e., a Fail grade). This grade will not be included in the GPA calculation. Students are required to re-take the course or co-curricular activities to fulfill the requirements for graduation..
...
- **_Grade_**: I. **_Grade Definitions_**: Incomplete.
- **_Grade_**: IP. **_Grade Definitions_**: In-Progress.
- **_Grade_**: MT. **_Grade Definitions_**: Multi-term (A/B).
- **_Grade_**: NGR. **_Grade Definitions_**: No Grade Report.
- **_Grade_**: W. **_Grade Definitions_**: Withdrawn.
- **_Grade_**: T. **_Grade Definitions_**: Transfer.
- **_Grade_**: Z. **_Grade Definitions_**: Exemption.
...
- **Classification of Awards**: Excellent. **Cumulative GPA**: 3.60 to 4.00.
- **Classification of Awards**: Very Good. **Cumulative GPA**: 3.20 to 3.59.
- **Classification of Awards**: Good. **Cumulative GPA**: 2.50 to 3.19.
- **Classification of Awards**: Marginal. **Cumulative GPA**: 2.00 to 2.49.
...
- Revision: V1.0. Date: May 22, 2020. Author / Editor: Prepared by: Head of Registrar.
